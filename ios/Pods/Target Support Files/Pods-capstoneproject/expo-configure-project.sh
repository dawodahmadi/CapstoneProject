...
with_node --no-warnings --eval "require('expo-modules-autolinking')(process.argv.slice(1))" generate-package-list  --target "/Users/ahmad/Downloads/capstoneproject/ios/Pods/Target Support Files/Pods-capstoneproject/ExpoModulesProvider.swift"
